...
# -----------------------------------------------------------------------------------------------------------------------
    ...
    path('add-half-day-slot', master.addHalfDaySlot, name='add-half-day-slot'),
    ...
    path('add-attendance', attendance.addAttendance, name='add-attendance'),
    path('save-attendance', attendance.saveAttendance, name='save-attendance'),
    path('add-dayout', attendance.addDayOut, name='add-dayout'),
    path('save-day-out', attendance.saveDayOut, name='save-day-out'),
    
    #Add Leave
    path('add-leaves', holiday.addLeaves, name='add-leaves'),
    path('get-emp-role-options/<int:employee_name>', holiday.empRoleOPtion, name='get-emp-role-options'),

    path('get-emp-leave-count/<int:employee_name>', holiday.getLeaveCount, name='get-emp-leave-count'),

    path('save-leaves', holiday.saveLeaves, name='save-leaves'),
    path('update-halfday-status', holiday.updateHalfdayStatus, name='update-halfday-status'),
    
    ##update endtime
    path('edit-endtime', report.editEndtime, name='edit-endtime'),
    path('get-employee-options/<str:att_date>', report.employeeList, name='get-employee-options'),
    path('update-end-time', report.updateEndtime, name='update-end-time'),
    path('delete-attandance', attendance.deleteAttandance, name='delete-attandance'),
    # --------------------------------new------------------------------------------------------
    path('get-bmc-list', master.ajaxBMCList, name='get-bmc-list'),
    path('add-bmc',master.addBMCList,name='add-bmc'),
    path('edit-bmc/<str:bmc_id>',master.editBMCList,name='edit-bmc'),
    path('update-bmc-status/<str:bmc_id>',master.updateBMCStatus,name='update-bmc-status'),

    path('export-BMC-Excel',bulkUpload.exportBMCExcel,name="export-BMC-Excel"),
    path('export-MPP-Excel',bulkUpload.exportMPPExcel,name="export-MPP-Excel"),
    
    path('import-bmc',bulkUpload.importBMC,name="import-bmc"),
    path('upload-bmc',bulkUpload.updateBMC,name="upload-bmc"),
    
    # mpp ............
    path('get-mpp-list', master.ajaxMPPList, name='get-mpp-list'),
    path('add-mpp',master.addMPPList,name='add-mpp'),
    path('edit-mpp/<str:mpp_id>',master.editMPPList,name='edit-mpp'),
    path('update-mpp-status/<str:mpp_id>',master.updateMPPStatus,name='update-mpp-status'),
    path('export-mpp-data',master.exportMpp,name="export-mpp-data"),
  

    # Bulk Upload MPP

    path('import-mpp',bulkUpload.importMPP,name="import-mpp"),
    path('upload-mpp',bulkUpload.updateMPP,name="upload-mpp"),
