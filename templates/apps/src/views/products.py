...
def index(request):
    ...
    paginator = Paginator(products, getConfigurationResult('page_limit'))
...
def addProductVariant(request,product_id):
    if request.method == "POST":
        ...
        try:
            ...
            product_variant.variant_color_code  = request.POST['variant_color_code']
            ...
            if product_variant.id:
                ...
                if len(operational_users) :
                    for operational_user in operational_users :
                        ...
                        user_product_variant.variant_color_code  = request.POST['variant_color_code']
